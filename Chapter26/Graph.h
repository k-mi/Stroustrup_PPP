...
struct Color {
    ...
    Color(unsigned int cc) :c(Fl_Color(cc)), v((char)visible) { }	// 引数の型をintからunsigned intに変更
...
#ifdef OBJ_TEXT
		cout << "Rectangle(Point(" << xy.x << "," << xy.y << ")," << ww << "," << hh << ")" << endl;
#endif
    }
...
#ifdef OBJ_TEXT
		cout << "Rectangle(Point(" << x.x << "," << x.y << "),Point(" << y.x << "," << y.y << "))" << endl;
#endif
    }
...
#ifdef OBJ_TEXT
		cout << "Text(Point(" << x.x << "," << x.y << ")," << s << ")" << endl;
#endif
	}
...
#ifdef OBJ_TEXT
		cout << "Circle(Point(" << p.x << "," << p.y << ")," << rr << ")" << endl;
#endif
	}
...
#ifdef OBJ_TEXT
		cout << "Ellipse(Point(" << p.x << "," << p.y << ")," << ww << "," << hh << ")" << endl;
#endif
	}
